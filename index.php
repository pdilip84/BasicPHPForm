...
<body>
    <div class="container border">
        ...
        <div class="row">
            <div class="col">
                <form action="<?php echo $_SERVER['REQUEST_URI']; ?>" method="post" onsubmit="return CheckFormValidation()" name="registrationform" enctype="">
                    <div class="form-group">
                        <label for="">User Name</label>
                        <input type="text" name="username" id="username" value="<?php if (isset($edituname)) {
                                                                                    echo $edituname;
                                                                                } ?>" class="form-control" placeholder="Your name please" aria-describedby="helpId" required>
                    ...
                    <div class="form-group">
                        ...
                        <input type="email" name="useremail" id="useremail" value="<?php if (isset($edituemail)) {
                                                                                        echo $edituemail;
                                                                                    } ?>" class="form-control" placeholder="Your valid email address" aria-describedby="helpId" required>
                        <small id="helpId" class="text-muted">Help text</small>
                    </div>
                    <div class="form-group">
